...
import correctImage from '../../../assets/HR-Dashboard/correct.png';
import settingsImage from '../../../assets/HR-Dashboard/settings.png';
import updateImage from '../../../assets/HR-Dashboard/update.png';
import deleteImage from '../../../assets/HR-Dashboard/delete.png';
        ...
        if (HRDepartmentState.success.status) {
            toast({
                ...
                description: <div className="flex justify-center items-center gap-2">
                    <img src={correctImage} alt="" className="w-6" />
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger>
                                <Button className="bg-blue-700 hover:bg-blue-900">
                                    <img src={settingsImage} alt="" className="w-5" />
                            ...
                            <DropdownMenuContent className="flex flex-col justify-center items-center p-2">
                                ...
                                <div className="buttons flex flex-col gap-2">
                                    <Button className="bg-blue-700 text-white font-bold text-sm hover:bg-blue-900">
                                        <img src={updateImage} alt="" className="w-5" />
                                        Update
                                    </Button>
